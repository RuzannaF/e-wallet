...
export const Arrow = () => {
    return <svg width="25px" height="25px" viewBox="0 0 32 32" version="1.1" fill="#2954ff" stroke="#2954ff">
    ...
    <g id="SVGRepo_iconCarrier">
        ...
        <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
            <g id="Icon-Set" transform="translate(-308.000000, -1087.000000)" fill="#2e89ff">
